...
//        highlightWordsField = new TextFieldWidget(minecraft.fontRenderer,width/2 - 100,90,200,20,"Test");
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        AbstractGui.drawString(matrixStack, minecraft.fontRenderer,"Custom Chat Keywords",width/2 - 100,20,16777215);
        customWordsField.render(matrixStack, mouseX, mouseY, partialTicks);
        AbstractGui.drawString(matrixStack, minecraft.fontRenderer,"Messages containing these phrases are",width/2 - 100,52,16777215);
        AbstractGui.drawString(matrixStack, minecraft.fontRenderer,"put into the 'Custom' second chat.",width/2 - 100,62,16777215);
        AbstractGui.drawString(matrixStack, minecraft.fontRenderer,"Separate phrases with commas.",width/2 - 100,72,16777215);
